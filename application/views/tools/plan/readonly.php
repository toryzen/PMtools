  ...
  <div class="container">
      ...
      <div class="page-header">
        <h2  style="margin-top:-30px"><?php echo $plan['bname']; ?> </h2>
        <p class="lead">开始:<?php echo $plan['begintime']; ?> 结束:<?php echo $plan['endtime']; ?> 排除:<?php if(is_array($plan['exceptdays'])){foreach($plan['exceptdays'] as $l){ @$exl.= $l."/"; }echo substr($exl,0,-1);}else{echo "无" ;} ?></p>
                ...
                <tr class="warning">
                  <td colspan="7">
                   <div class="row">
                  	...
                  	<div class="col-md-2"><b>时间:</b><?php echo $t['timepoint']; ?></div>

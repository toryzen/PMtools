...
<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url();?>static/Validform/css/style.css"/>
  ...
  <div class="container">
      ...
      <div class="page-header">
        <h2 style="margin-top:-30px">新建面板 </h2>
      ...
      <p></p>
      <div class="row">
        <div class="col-md-2"><input name="borad[bname]" value="" class="form-control" type="text"  placeholder="名称" errormsg="至少1个字符,最多50个字符！" datatype="*1-50"/></div>
        <div class="col-md-3">
          <div class="input-group">
            <input name="borad[begintime]" value="" id="begin_time" class="form-control" type="text" placeholder="开始日期" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="/\d{4}-\d{2}-\d{2}/i"/>
            <span class="input-group-addon"><span class="glyphicon glyphicon glyphicon-calendar"></span></span>
          </div>
        </div>
        <div class="col-md-3">
          <div class="input-group">
            <input name="borad[endtime]" value="" id="end_time" class="form-control" type="text" placeholder="结束日志" onclick="WdatePicker({onpicked:function(){change_except();},dateFmt:'yyyy-MM-dd'})" datatype="/\d{4}-\d{2}-\d{2}/i"/>
            <span class="input-group-addon"><span class="glyphicon glyphicon glyphicon-calendar"></span></span>
          </div>
        </div>
        <div class="col-md-4">
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <tr id="tr_demo" class="hide">
              ...
              <td><input pubtype="people" class="form-control" type="text" name="task[owner][]"  placeholder="所有者"  datatype="*"/></td>
              <td>
	              <div class="input-group">
